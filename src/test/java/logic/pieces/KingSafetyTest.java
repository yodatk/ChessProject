...
public class KingSafetyTest {
    ...
    public void kingSafetyTest(){
        ...
        board.setGivenPieceOnBoard(whiteKing);
        board.setGivenPieceOnBoard(blackQueen);
        ...
        board.emptyAGivenTileCoordination(Coordinate.H1);
        board.emptyAGivenTileCoordination(Coordinate.F3);
        ...
        board.setGivenPieceOnBoard(whiteRook);
        board.setGivenPieceOnBoard(whiteKing);
        board.setGivenPieceOnBoard(blackQueen);
        board.getBlacksPieces().add(blackQueen);
        ...
        board.emptyAGivenTileCoordination(Coordinate.F2);
        board.setGivenPieceOnBoard(whiteRook);
        ...
        board.setGivenPieceOnBoard(whiteRook);
        board.setGivenPieceOnBoard(whiteKing);
        board.setGivenPieceOnBoard(whiteRook2);
        board.setGivenPieceOnBoard(p1);
        board.setGivenPieceOnBoard(p2);
        board.setGivenPieceOnBoard(p3);
        board.setGivenPieceOnBoard(blackKnight);
