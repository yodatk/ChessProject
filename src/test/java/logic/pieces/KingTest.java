...
public class KingTest {
    ...
    public void calculateAllPossibleMoves() {
        ...
        currentBoard.setGivenPieceOnBoard(blackRook);
        currentBoard.setGivenPieceOnBoard(whiteRook);
        ...
        currentBoard.setGivenPieceOnBoard(test4Knight1);
        currentBoard.setGivenPieceOnBoard(test4Knight2);
