...
public class KnightTest {
    ...
    public void calculateAllPossibleMoves() {
        ...
        currentBoard.setGivenPieceOnBoard(new Rook(Piece.Color.BLACK, Coordinate.C7));
        currentBoard.setGivenPieceOnBoard(new Rook(Piece.Color.WHITE, Coordinate.B7));
        ...
        currentBoard.setGivenPieceOnBoard(new Pawn(Piece.Color.BLACK, Coordinate.B6));
        currentBoard.setGivenPieceOnBoard(new Pawn(Piece.Color.WHITE, Coordinate.C7));
        currentBoard.setGivenPieceOnBoard(new Pawn(Piece.Color.WHITE, Coordinate.F4));
        currentBoard.setGivenPieceOnBoard(new Pawn(Piece.Color.BLACK, Coordinate.E3));
