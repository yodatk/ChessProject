...
public class GameManager {
    ...
    public void promotionFunction(Pawn toPromote, char promotion){
        ...
        Coordinate pawn_to_promote_tile = toPromote.getCoordinate();
        ...
        this.gameBoard.emptyAGivenTileCoordination(pawn_to_promote_tile);
        //pawn_to_promote_tile.setCurrentPiece(promotionPiece);
        this.gameBoard.setGivenPieceOnBoard(promotionPiece);
